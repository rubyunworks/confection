...
Confection is multi-tenant confirguration system for Ruby projects. If was 
...
Create a file in you project called `.co`. In it add configuration blocks
by name.

As an example let's demonstrate how we could use this for our Rake tasks.
